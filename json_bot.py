...
bot = TeleBot(token='5405190643:AAEHXhTmURFNTlM33iJuuVsps-m9cMsLY_o', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Сейчас проверим твой JSON и сделаем его красивым\nВведи JSON в виде строки:', # текст сообщения
    )
...
def message_handler(message: types.Message):
    try:
        ...
        bot.send_message(
            ...
            text=f'Ошибка находится вот тут:\n<code>{str(ex)}</code>'
        )
        # выходим из функции
        return
